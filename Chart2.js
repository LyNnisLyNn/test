...
function loadChart() {
  ...
  const width = 900, height = 450, margin = { top: 70, right: 25, bottom: 60, left: 50 };
  ...
  svg.append("text")
    ...
    .style("fill", "#333")
    .text("Hospital admissions for congestive heart failure in adults");
  ...
  svg.append("text")
    ...
    .style("fill", "#666")
    .text("Age-sex standardised rates per 100 000 population");
